...
작업 내역 : Load 함수 추가(2017/02/24)
		   ...
		   배열라이브러리 적용관련해서 Personal / AddressBook_GetAt사용 추가(2017/03/12)
*/
...
작 성 자 : Joey
작성 일자 : 2017/02/23
작성 일자 : 2017/03/01 UpdatingForm_OnFindingZipcodeButtonClicked 추가
*/
BOOL UpdatingForm_OnCommand(HWND hWnd, WPARAM wParam, LPARAM lParam) {
	...
	switch (LOWORD(wParam)) {
		...
		case IDC_BUTTON_FINDINGZIPCODE:	//2017.03.01 PostalBook 추가
...
작업 내역 : Save 함수 추가(2017/02/24)
           AddressBook_Save / AddressBook_Destroy 함수명 수정(2017/03/12)
*/
...
/*
함수 명칭 : UpdatingForm_OnFindingZipcodeButtonClicked
기    능 : 우편번호찾기 버튼을 눌렀을때, 우편번호 찾기 프레임 윈도우를 출력한다.
출    력 : FALSE
입    력 : 윈도우핸들, 정보1, 정보2
작 성 자 : Joey
작성 일자 : 2017/03/01
